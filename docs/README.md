...
47. `docs/46-automation-blueprint.md` — полный план автоматизации: как запустить sales/marketing/CS без людей (~$254/мес вместо $4,500/мес).

## Дополнительные материалы

- `docs/LLM_CONTEXT.md` — точка входа для LLM-систем (быстрый контекст проекта)
- `docs/CHANGELOG.md` — план изменений в коде/сайте под стратегию продаж
- `docs/sales/` — готовые sales-материалы (pptx, docx)
